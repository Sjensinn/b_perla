...
SOURCEFILES_QUOTED_IF_SPACED=newmain.c PCA9685_driver.c I2C_MSSP1_driver.c tcs3200.c LCD.c system_init.c timer1.c litaflokkari.c uart.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/newmain.p1 ${OBJECTDIR}/PCA9685_driver.p1 ${OBJECTDIR}/I2C_MSSP1_driver.p1 ${OBJECTDIR}/tcs3200.p1 ${OBJECTDIR}/LCD.p1 ${OBJECTDIR}/system_init.p1 ${OBJECTDIR}/timer1.p1 ${OBJECTDIR}/litaflokkari.p1 ${OBJECTDIR}/uart.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/newmain.p1.d ${OBJECTDIR}/PCA9685_driver.p1.d ${OBJECTDIR}/I2C_MSSP1_driver.p1.d ${OBJECTDIR}/tcs3200.p1.d ${OBJECTDIR}/LCD.p1.d ${OBJECTDIR}/system_init.p1.d ${OBJECTDIR}/timer1.p1.d ${OBJECTDIR}/litaflokkari.p1.d ${OBJECTDIR}/uart.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/newmain.p1 ${OBJECTDIR}/PCA9685_driver.p1 ${OBJECTDIR}/I2C_MSSP1_driver.p1 ${OBJECTDIR}/tcs3200.p1 ${OBJECTDIR}/LCD.p1 ${OBJECTDIR}/system_init.p1 ${OBJECTDIR}/timer1.p1 ${OBJECTDIR}/litaflokkari.p1 ${OBJECTDIR}/uart.p1

# Source Files
SOURCEFILES=newmain.c PCA9685_driver.c I2C_MSSP1_driver.c tcs3200.c LCD.c system_init.c timer1.c litaflokkari.c uart.c
...
${DISTDIR}/PIC16f18877_v6.1.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} ${DISTDIR} 
	${MP_CC} $(MP_EXTRA_LD_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -Wl,-Map=${DISTDIR}/PIC16f18877_v6.1.X.${IMAGE_TYPE}.map  -D__DEBUG=1  -mdebugger=none  -DXPRJ_default=$(CND_CONF)  -Wl,--defsym=__MPLAB_BUILD=1   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -O0 -fasmfile -maddrqual=ignore -xassembler-with-cpp -mwarn=-3 -Wa,-a -msummary=-psect,-class,+mem,-hex,-file  -ginhx32 -Wl,--data-init -mno-keep-startup -mno-osccal -mno-resetbits -mno-save-resetbits -mno-download -mno-stackcall -mdefault-config-bits -std=c99 -gdwarf-3 -mstack=compiled:auto:auto        $(COMPARISON_BUILD) -Wl,--memorysummary,${DISTDIR}/memoryfile.xml -o ${DISTDIR}/PIC16f18877_v6.1.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
